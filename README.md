...
LabMind_项目文档 - Medical AI Project
...
1. **克隆仓库**
```bash
git clone https://github.com/MoKangMedical/LabMind--.git
cd LabMind--
```
...
1. **构建镜像**
```bash
docker build -t LabMind-- .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name LabMind-- LabMind--
```
...
- **项目主页**: https://github.com/MoKangMedical/LabMind--
- **问题反馈**: https://github.com/MoKangMedical/LabMind--/issues
